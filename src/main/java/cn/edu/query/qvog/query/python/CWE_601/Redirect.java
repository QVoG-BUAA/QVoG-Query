package cn.edu.query.qvog.query.python.CWE_601;
...
public class Redirect extends PythonQuery {
    public static void main(String[] args) {
        QueryEngine.getInstance().execute(new Redirect()).close();
    }

    @Override
    public String getQueryName() {
        return "CWE-601: Redirect";
    }
    ...
    public CompleteQuery run() {
        return QueryDescriptor.open()
                ...
                .from("sink", new ContainsFunctionCall("redirect"))
